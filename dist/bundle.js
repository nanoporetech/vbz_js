...
var $gYrdT$wasmfeaturedetect = require("wasm-feature-detect");
...
let $b0e90092f9853fbf$var$streamvbyte;
let $b0e90092f9853fbf$var$Module;
...
parcelRequire.register("eWIFP", function(module, exports) {

$parcel$defineInteropFlag(module.exports);

$parcel$export(module.exports, "default", () => $c0aee7a0d0b12351$export$2e2bcd8739ae039);
...
parcelRequire.register("h1uhA", function(module, exports) {

$parcel$defineInteropFlag(module.exports);

$parcel$export(module.exports, "default", () => $cb11f733b2b8fdcb$export$2e2bcd8739ae039);



var $cb11f733b2b8fdcb$var$Module = (()=>{
    var _scriptDir = "file:///dist/streamvbyte-no-simd.mjs";
    return function(Module) {
        Module = Module || {
        };
        var Module = typeof Module != "undefined" ? Module : {
        ...
        var wasmBinaryFile;
        wasmBinaryFile = "data:application/octet-stream;base64,";
        if (!isDataURI(wasmBinaryFile)) wasmBinaryFile = locateFile(wasmBinaryFile);
        function getBinary(file) {
            try {
                if (file == wasmBinaryFile && wasmBinary) return new Uint8Array(wasmBinary);
...
var $cb11f733b2b8fdcb$export$2e2bcd8739ae039 = $cb11f733b2b8fdcb$var$Module;

});


(async ()=>{
    const simdSupported = await $gYrdT$wasmfeaturedetect.simd();
    if (simdSupported) {
        $b0e90092f9853fbf$var$streamvbyte = (parcelRequire("eWIFP"));
        console.log('simd');
    } else {
        $b0e90092f9853fbf$var$streamvbyte = (parcelRequire("h1uhA"));
        console.log('no simd');
    }
    $b0e90092f9853fbf$var$Module = $b0e90092f9853fbf$var$streamvbyte.default();
